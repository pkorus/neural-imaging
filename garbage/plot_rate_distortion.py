...
sns.lineplot(data=df_j, x='bpp', y='ssim', ax=axes)
sns.scatterplot(data=df_d, x='bpp', y='ssim', hue='layers', style='quantization', size='quality',
                ax=axes, legend='full')
...
fig = plotting.imsc(images, df_selected['label'].tolist(), figwidth=30)